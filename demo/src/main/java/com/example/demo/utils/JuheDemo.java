...
public class JuheDemo {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="2a05a808136238dfbd99de9e84dc742c";
    ...
    //2.发送短信
    public static String   getRequest2(AppLoginInfo appLoginInfo){
      int verifyCode=  (int)(( Math.random()*9+1)*100000);
      String tpl_value="#code#="+ verifyCode ;
        String result =null;
        String url ="http://v.juhe.cn/sms/send";//请求接口地址
        Map params = new HashMap();//请求参数
            params.put("mobile",appLoginInfo.getPhone());//接收短信的手机号码
            params.put("tpl_id","75549");//短信模板ID，请参考个人中心短信模板设置
